...
3. Enter the following
   * https://github.com/Augmencia/UnityRuntimePositioner3D.git?path=/Packages/RuntimePositioner3D#1.0.5
...
{
    "dependencies": {
         "com.augmencia.runtimepositioner3d": "https://github.com/Augmencia/UnityRuntimePositioner3D.git?path=/Packages/RuntimePositioner3D#1.0.5"
    }
}
```
